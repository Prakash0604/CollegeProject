...
<?php 
		if(isset($_POST['add'])){
            ...
            connect()->query("DELETE FROM students WHERE id LIKE '$roll'");
   ...
   <section>
       <div class="row">
           ...
           <div class="col-md-7 offset-md-3 text-center edit" style="margin-top:-1100px">
           <h2>Delete Student by Roll Number</h2><br>
            <form action="" method="POST">
                <div class="form-group">
                    <p style="color:#8a6600;font-weight:600">Delete by Roll No: </p><input type="text" class="w-25;margin-left:120px" name="roll" class="form-control">
                    <input type="submit" name="add" value="Delete" class="btn btn-info">
