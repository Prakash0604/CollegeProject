...
if(isset($_POST['edit'])){
  ...
  connect()->query("UPDATE students SET fname='$fname',lname='$lname',mother_name='$mname',father_name='$faname',dob='$dob',email='$email',password='$pass',mobile='$mobile',class='$class',address='$address' where roll_no='{$_SESSION['roll']}'");
...
?>
                <form action="" method="POST" entype="multipart/form-data">
					...
					<div class="form-group">
						...
						<input name="mname" class="form-control" value="<?php echo $login_data->mother_name; ?>" type="text">
					</div>
                    <div class="form-group">
						<label for="">Father's Name</label>
						<input name="faname" class="form-control"  value="<?php echo $login_data->father_name;  ?>" type="text" >
					</div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
						...
						<input name="class" class="form-control" value="<?php echo $login_data->class; ?>" type="text">
					</div>
                    <div class="form-group">
