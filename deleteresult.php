...
<?php 
		if(isset($_POST['add'])){
            ...
            connect()->query("DELETE FROM results WHERE id LIKE '$roll'");
   ...
   <section>
       <div class="row">
           ...
           <h2>Delete Student Result by Roll Number</h2><br>
            <form action="" method="POST">
                <div class="form-group">
                    <p style="color:#8a6600;font-weight:600">Delete result by Roll No: </p><input type="text" class="w-25;margin-left:120px" name="roll" class="form-control">
